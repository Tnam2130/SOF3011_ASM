...
//    }
    ...
    public static final String FROM_EMAIL = "trungnam101183@gmail.com";
    public static final String EMAIL_PASSWORD = "jowrvieoaredeunp";
    ...
    public static boolean sendShareEmail(String[] recieves, User user, Video video, String baseURL)
        ...
        String body = getTemplate(user.getUsername() == null ? "Ai đó " : user.getUsername(), video.getHref(), baseURL);
